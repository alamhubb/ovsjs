...
// TODO: 添加 DefaultTokHoistableDeclarationClassDeclarationAssignmentExpression 的完整测试用例
// 当前从 Expression 的内容中提取

const assert = require('assert');
const { parse } = require('../../packages/slime-parser');

describe('DefaultTokHoistableDeclarationClassDeclarationAssignmentExpression', () => {
  it('should parse DefaultTokHoistableDeclarationClassDeclarationAssignmentExpression', () => {
    // TODO: 补充实现测试
  });
});
