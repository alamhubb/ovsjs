export default {
  name: "my-uni-render-project",
  version: "0.0.0",
  description: "Qin-managed UniApp OVS demo application",
  type: "fullstack",
  frontend: {
    srcDir: "src",
    entry: "src/main.ts",
  ...
  devDependencies: {
    ...
    "vite": "5.2.8",
    "vue-tsc": "^1.0.24",
    "vite-plugin-uni-render": "^0.0.1-alpha.10"
  },
  language: {
    id: "ovs",
    extension: ".ovs",
